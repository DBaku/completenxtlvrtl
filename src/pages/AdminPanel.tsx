...
const AdminPanel: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API call to upload artwork
    setTimeout(() => {
      // Create a new artwork object with a generated ID
      const newArtwork = {
        id: `artwork-${Date.now()}`,
        title: form.title,
      ...
      <header className="bg-charcoal-900 text-white py-4">
        <div className="container-custom">
          <div className="flex items-center justify-between">
            ...
            <button className="btn-primary bg-gold-600 py-2">Back to Website</button>
          </div>
        </div>
      </header>
            ...
            <div className="bg-white shadow-md p-6">
              ...
              <nav>
                <ul className="space-y-2">
                  <li>
                    <a href="#" className="block px-4 py-2 bg-gold-50 text-gold-700 border-l-4 border-gold-600">
                      Upload Artwork
                    </a>
                  </li>
                  <li>
          ...
          <main className="lg:col-span-2">
            <div className="bg-white shadow-md p-6">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* Additional options */}
                <div className="bg-gray-50 p-4 mb-6 border border-gray-200 rounded-md">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      <input 
                        ...
                        className="h-4 w-4 text-gold-600 focus:ring-gold-500 border-gray-300 rounded" 
                      />
                      <label htmlFor="limited" className="ml-2 text-gray-700">
                        Limited edition
                      </label>
                    </div>
                  </div>
            ...
            {artworks.length > 0 && (
              <div className="bg-white shadow-md p-6 mt-8">
                <h2 className="font-serif text-xl font-bold mb-6">Recently Added Artworks</h2>
